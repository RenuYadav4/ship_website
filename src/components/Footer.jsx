...
const Footer = () => {
  return (
    <footer className="w-full bg-[#1A1D2B] text-gray-300 pt-16 pb-8 px-6 md:px-16 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-white/10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li className="hover:text-white transition cursor-pointer">OUR CREW TEAM</li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li className="hover:text-white transition">COMMERCIAL MANAGEMENT</li>
            <li className="hover:text-white transition">TECHNICAL MANAGEMENT</li>
            <li className="hover:text-white transition">CREW MANAGEMENT</li>
            <li className="hover:text-white transition">CONSULTANCY SERVICES</li>
          </ul>
        </div>
